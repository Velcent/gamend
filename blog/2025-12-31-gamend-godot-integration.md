...
The [godot_hook](https://github.com/appsinacup/gamend_godot_hook) is available in its own repo. The Dockerfile **downloads Godot**, and then the godot_hook starts it and **forwards hook events**.
