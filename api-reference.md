# game_server_core v1.0.1087 - API Reference
...
hotlinking the provider.
  - [GameServer.Accounts.InactivityNotifier](GameServer.Accounts.InactivityNotifier.md): Warns a user their account is about to be deleted for inactivity.
...
aggregated from telemetry events
  ...
  - [GameServer.Lock.Local](GameServer.Lock.Local.md): Reentrant, cluster-wide keyed mutex — the non-Postgres half of
`GameServer.Lock.serialize/3`.
