# `GameServer.Quests.QuestProgress`
[🔗](https://github.com/appsinacup/game_server/blob/v1.0.7/lib/game_server/quests/quest_progress.ex#L1)
...
```elixir
@type t() :: %GameServer.Quests.QuestProgress{
  __meta__: term(),
  claimed_at: term(),
  completed_at: term(),
  id: term(),
