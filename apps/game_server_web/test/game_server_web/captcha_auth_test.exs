defmodule GameServerWeb.CaptchaAuthTest do
  @moduledoc """
  ...
  setup do
    Application.put_env(:game_server_core, :captcha_req_options, plug: {Req.Test, __MODULE__})
    previous = Application.get_env(:game_server_core, Captcha)

    Application.put_env(:game_server_core, Captcha,
      enabled: true,
      site_key: "0x4AAAtest",
      secret_key: "secret"
    )
    ...
    previous_limit = Application.get_env(:game_server_web, GameServerWeb.Plugs.RateLimiter, [])
    ...
    on_exit(fn ->
      Application.delete_env(:game_server_core, :captcha_req_options)
      ...
      if previous,
        do: Application.put_env(:game_server_core, Captcha, previous),
        else: Application.delete_env(:game_server_core, Captcha)
    end)
  ...
  defp disable_captcha do
    Application.put_env(:game_server_core, Captcha, enabled: false)
  end
