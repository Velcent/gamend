defmodule GameServerWeb.OAuthProviderToggleTest do
  @moduledoc """
  ...
  setup do
    orig = Application.get_env(:game_server_core, Providers)

    on_exit(fn ->
      if is_nil(orig) do
        Application.delete_env(:game_server_core, Providers)
      else
        Application.put_env(:game_server_core, Providers, orig)
      end
    end)
  ...
  defp configure(settings), do: Application.put_env(:game_server_core, Providers, settings)
