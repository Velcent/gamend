defmodule Gamend.DataCase do
  ...
  by setting `use Gamend.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = SQL.Sandbox.start_owner!(Gamend.Repo, shared: not tags[:async])
  ...
  # `Gamend.Async` side effects run as supervised tasks that outlive the
  ...
  defp running_tasks do
    case Process.whereis(Gamend.TaskSupervisor) do
      nil -> %{}
