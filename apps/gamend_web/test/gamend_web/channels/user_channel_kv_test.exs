defmodule GamendWeb.UserChannelKvTest do
  ...
  setup tags do
    ...
    original_hooks_module = Application.get_env(:gamend_core, :hooks_module)
    ...
    on_exit(fn ->
      if original_hooks_module do
        Application.put_env(:gamend_core, :hooks_module, original_hooks_module)
      else
