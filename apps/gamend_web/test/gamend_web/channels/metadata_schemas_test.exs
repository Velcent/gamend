defmodule GamendWeb.MetadataSchemasTest do
  ...
  defmodule FakeHooks do
    def metadata_schemas, do: %{party: GamendWeb.MetadataSchemasTest.LobbyMeta}
  end
  ...
  defmodule ExplicitOther do
    def metadata_schemas, do: %{user: GamendWeb.MetadataSchemasTest.OtherMeta}
  end
  ...
  defmodule KvHooksZ do
    def kv_schemas, do: %{"loadout" => GamendWeb.MetadataSchemasTest.UserMeta}
  end
  ...
  defmodule KvHooks do
    def kv_schemas do
      %{
        "loadout" => GamendWeb.MetadataSchemasTest.LobbyMeta,
        "match:*" => GamendWeb.MetadataSchemasTest.UserMeta
      }
    end
  end
