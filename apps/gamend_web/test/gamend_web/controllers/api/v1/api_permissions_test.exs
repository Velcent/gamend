defmodule GamendWeb.Api.V1.ApiPermissionsTest do
  @moduledoc """
  ...
  describe "authenticated API endpoints return 401 without token" do
    @auth_endpoints [
      ...
      {:post, "/api/v1/lobbies/unmute"},
      {:get, "/api/v1/lobbies/mutes"},
      # Ready checks
      ...
      {:post, "/api/v1/groups/1/mute"},
      {:post, "/api/v1/groups/1/unmute"},
      {:get, "/api/v1/groups/1/mutes"},
      ...
      {:post, "/api/v1/parties/mute"},
      {:post, "/api/v1/parties/unmute"},
      {:get, "/api/v1/parties/mutes"},
      ...
      {:post, "/api/v1/chat/messages/1/report"},
  ...
  describe "admin API endpoints return 401 without token" do
    @admin_endpoints [
      ...
      {:post, "/api/v1/admin/chat/reports/1/resolve"},
      {:delete, "/api/v1/admin/chat/reports/1"},
      {:get, "/api/v1/admin/chat/mutes"},
      {:post, "/api/v1/admin/chat/mutes"},
      {:delete, "/api/v1/admin/chat/mutes/1"},
      {:get, "/api/v1/admin/chat/filter_words"},
      {:post, "/api/v1/admin/chat/filter_words"},
      {:patch, "/api/v1/admin/chat/filter_words/1"},
      {:delete, "/api/v1/admin/chat/filter_words/1"},
      {:post, "/api/v1/admin/chat/filter_words/import"},
      {:post, "/api/v1/admin/chat/filter_words/test"},
      # Ready checks Admin
