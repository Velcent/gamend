defmodule GamendWeb.AdminLive.LobbySnapshotsTest do
  ...
  setup %{conn: conn} do
    ...
    Application.put_env(:gamend_core, LobbySnapshots, enabled: true, user_kv_keys: [])
    on_exit(fn -> Application.put_env(:gamend_core, LobbySnapshots, previous) end)
