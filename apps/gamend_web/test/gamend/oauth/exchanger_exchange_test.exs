defmodule Gamend.OAuth.ExchangerExchangeTest do
  ...
  defmodule TestClient do
    ...
    def get("https://appleid.apple.com/auth/keys") do
      jwk = Application.fetch_env!(:gamend_core, :apple_test_jwk)
    ...
    defp apple_token(claims) do
      Application.fetch_env!(:gamend_core, :apple_test_jwk)
  ...
  setup do
    Application.put_env(:gamend_core, :apple_test_jwk, JOSE.JWK.generate_key({:rsa, 2048}))
    Application.put_env(:gamend_core, :oauth_exchanger_client, TestClient)
    ...
    on_exit(fn ->
      Application.delete_env(:gamend_core, :apple_test_jwk)
      Application.delete_env(:gamend_core, :oauth_exchanger_client)
