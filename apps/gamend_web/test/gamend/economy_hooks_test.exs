defmodule Gamend.EconomyHooksTest do
  ...
  defmodule Hook do
    ...
    def after_wallet_changed(change) do
      if pid = Application.get_env(:gamend_core, :test_econ_pid),
  ...
  setup do
    ...
    Application.put_env(:gamend_core, :test_econ_pid, self())
    Application.put_env(:gamend_core, :hooks_module, Hook)

    on_exit(fn ->
      Application.put_env(:gamend_core, :hooks_module, orig)
      Application.delete_env(:gamend_core, :test_econ_pid)
    end)
