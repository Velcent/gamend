[
  ...
  {"lib/gamend_web/controllers/api/v1/friend_controller.ex",
  ...
  {"lib/gamend_web/live/admin_live/users/index.ex",
   "The pattern can never match the type true."},
  {"lib/gamend_web/live/groups_live.ex", "The pattern can never match the type true."},
  {"lib/gamend_web/live/lobby_live/index.ex", "The pattern can never match the type true."},
  {"lib/gamend_web/live/user_live/settings.ex", "The pattern can never match the type true."}
]
