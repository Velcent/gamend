...
if System.get_env("GAMEND_DB_URL") ||
  ...
  database_url =
    System.get_env("GAMEND_DB_URL") ||
      "ecto://#{System.get_env("GAMEND_DB_POSTGRES_USER")}:#{System.get_env("GAMEND_DB_POSTGRES_PASSWORD")}@#{System.get_env("GAMEND_DB_POSTGRES_HOST")}:#{System.get_env("GAMEND_DB_POSTGRES_PORT", "5432")}/#{System.get_env("GAMEND_DB_POSTGRES_DB", "gamend_web_dev")}"
...
config :gamend_web, GamendWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/gamend_web/(?:controllers|live|components|router|plugs)/?.*\.(ex|heex)$"
    ]
  ]
...
# declared Gamend.Mail settings. This app only needs the local adapter's
