defmodule GamendWeb.AdminLive.Settings do
  @moduledoc """
  ...
  guarantee is that the list is complete: it renders `Gamend.Settings.all/0`,
  ...
  defp environment, do: Application.get_env(:gamend_web, :environment, :prod)
