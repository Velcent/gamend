defmodule GamendWeb.Icons do
  ...
  # heroicons is declared by the HOST app, not by gamend_web (it is a
  ...
  unless @icons_dir do
    ...
    The host app must declare it (see apps/gamend_web/mix.exs) and run mix deps.get.
    """
  end
