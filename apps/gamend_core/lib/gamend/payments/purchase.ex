defmodule Gamend.Payments.Purchase do
  @moduledoc """
  ...
  schema "purchases" do
    ...
    belongs_to :product, Gamend.Payments.Product
    belongs_to :provider_product, Gamend.Payments.ProviderProduct
    ...
    has_many :entitlements, Gamend.Payments.Entitlement, foreign_key: :source_purchase_id
...
defimpl Jason.Encoder, for: Gamend.Payments.Purchase do
