defmodule Gamend.Cache.Sync do
  @moduledoc """
  ...
  @impl true
  def init(_opts) do
    Phoenix.PubSub.subscribe(Gamend.PubSub, Cache.invalidation_topic())
    {:ok, %{}}
  end
  ...
  # `Gamend.Cache.bump_version/1`. Only L1 is touched: a shared L2 was
