defmodule Gamend.Tournaments.Tournament do
  @moduledoc """
  ...
  schema "tournaments" do
    ...
    has_many :entries, Gamend.Tournaments.Entry
  ...
  def changeset(tournament, attrs) do
    ...
    |> validate_length(:slug, min: 1, max: Gamend.Limits.get(:max_tournament_slug))
    |> validate_length(:title, min: 1, max: Gamend.Limits.get(:max_tournament_title))
    |> validate_length(:description, max: Gamend.Limits.get(:max_tournament_description))
    ...
    |> validate_number(:max_entries,
      greater_than: 1,
      less_than_or_equal_to: Gamend.Limits.get(:max_tournament_entries)
    )
  ...
  defp validate_bracket_size(changeset) do
    max = Gamend.Limits.get(:max_tournament_bracket_size)
