  ...
  **Note:** This is an SDK stub. Calling these functions will raise an error.
  ...
  def bracket_rounds(_size) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.bracket_rounds/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def bracket_size_for(_n, _max) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.bracket_size_for/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def change_tournament(_tournament, _attrs \\ %{}) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.change_tournament/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def count_brackets(_tournament_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.count_brackets/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def count_tournament_groups() do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.count_tournament_groups/0 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def count_tournaments(_opts \\ []) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.count_tournaments/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def entries_by_id(_tournament_id, _entry_ids) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.entries_by_id/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec get_tournament_by_slug(String.t()) :: Gamend.Tournaments.Tournament.t() | nil
  ...
  def list_entries(_tournament_id, _opts \\ []) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.list_entries/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec list_occurrences(String.t()) :: [Gamend.Tournaments.Tournament.t()]
  ...
  def list_tournament_groups(_opts \\ []) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.list_tournament_groups/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def match_index(_slot, _round) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.match_index/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def match_payload(_tournament, _match) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.match_payload/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec round_deadline(Gamend.Tournaments.Tournament.t(), pos_integer()) :: DateTime.t()
  def round_deadline(_tournament, _round) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.round_deadline/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def round_matches(_size, _round) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.round_matches/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec round_opens_at(Gamend.Tournaments.Tournament.t(), pos_integer()) :: DateTime.t()
  ...
  def standard_seed_order(_size) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.standard_seed_order/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec standings(Gamend.Tournaments.Tournament.t()) :: map()
  def standings(_tournament) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.standings/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def tick(_now \\ DateTime.utc_now()) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.Tournaments.tick/1 is a stub - only available at runtime on Gamend"
    end
  end
