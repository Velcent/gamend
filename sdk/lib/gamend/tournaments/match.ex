defmodule Gamend.Tournaments.Match do
  @moduledoc """
  ...
  `Gamend.Tournaments.resolve_match/2` called before the deadline.
  ...
  @type t :: %__MODULE__{
          ...
          tournament: Gamend.Tournaments.Tournament.t() | nil,
          bracket_index: integer(),
          round: integer(),
          slot: integer(),
          a_entry_id: String.t() | nil,
          b_entry_id: String.t() | nil,
          a_entry: Gamend.Tournaments.Entry.t() | nil,
          b_entry: Gamend.Tournaments.Entry.t() | nil,
