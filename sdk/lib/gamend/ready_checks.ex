  ...
  **Note:** This is an SDK stub. Calling these functions will raise an error.
  ...
  def add_member(_lobby_id, _user_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.add_member/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def add_party_member(_party_id, _user_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.add_party_member/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def cancel_for_lobby(_lobby_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.cancel_for_lobby/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def count_checks(_opts \\ []) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.count_checks/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def expire_due(_now \\ DateTime.utc_now()) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.expire_due/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def list_checks(_opts \\ []) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.list_checks/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  """
  @spec passed?(Gamend.Lobbies.Lobby.t() | Gamend.Parties.Party.t() | Ecto.UUID.t()) :: boolean()
  def passed?(_lobby_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.passed?/1 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def remove_member(_lobby_id, _user_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.remove_member/2 is a stub - only available at runtime on Gamend"
    end
  end
  ...
  def remove_party_member(_party_id, _user_id) do
    case Application.get_env(:gamend_sdk, :stub_mode, :raise) do
      ...
      _ ->
        raise "Gamend.ReadyChecks.remove_party_member/2 is a stub - only available at runtime on Gamend"
    end
  end
