...
[🔗](https://github.com/appsinacup/game_server/blob/v1.0.7/lib/game_server/ready_checks.ex#L1)
...
```elixir
@spec not_ready(GameServer.ReadyChecks.Check.t()) :: [
  GameServer.ReadyChecks.Participant.t()
]
```
