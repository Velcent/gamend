# `GameServer.Push.Provider`
[🔗](https://github.com/appsinacup/game_server/blob/v1.0.7/lib/game_server/push/provider.ex#L1)
...
```elixir
@callback deliver(GameServer.Push.Message.t(), GameServer.Push.PushToken.t()) :: result()
```
